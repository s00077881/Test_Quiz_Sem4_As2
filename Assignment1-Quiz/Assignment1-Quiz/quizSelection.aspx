...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentBlock" runat="server">
    ...
    <div id="content">
        <div class="col-md-3 col-sm-6 col-xs-6" id="genK">
            <label>General Knowledge</label>
            <asp:ImageButton ID="btnGeneralCat" CssClass="img-responsive" runat="server" AlternateText="General Knowledge" ImageUrl="~/images/general.png" OnClientClick="function{return false;}" OnClick="btnCat_Click" />
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6" id="movie">
            <label>Movies</label>
        ...
        <div class="col-md-3  col-sm-6 col-xs-6" id="music">
            <label>Music</label>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6" id="sport">
            <label>Sports</label>
        ...
        <div class="col-md-12" id="dropBox">

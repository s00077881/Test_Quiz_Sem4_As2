...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentBlock" runat="server">
    ...
    <asp:DropDownList ID="lstCountries" runat="server">
        <asp:ListItem Value="00">-- Select Nationality --</asp:ListItem>
    ...
    <asp:RequiredFieldValidator ID="rfvNationality" ControlToValidate="lstCountries" ErrorMessage="*Please select nationality." InitialValue="00" runat="server" />
